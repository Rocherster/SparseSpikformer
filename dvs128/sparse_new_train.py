...
def parse_args():
    ...
    parser.add_argument('--model', default='SparseTr_new', help='model')
...
def main(args):
    ...
    pretrained = torch.load('/home/ly22216501/SNN/transformer/SparseSpikformer/dvs128-gesture/logs/Spikformer_b16_T16_wd0.06_adamw_cnf_ADD/lr0.01/checkpoint_max_test_acc1.pth', map_location='cpu')
    ...
    baserate =  args.base_rate
    criterion_train = DistillDiffPruningLoss_dynamic(
            teacher_model, criterion_train, clf_weight=1.0, keep_ratio=[baserate,baserate**2,baserate**3], mse_token=True, ratio_weight=args.ratio_weight, distill_weight=0.5
        )
