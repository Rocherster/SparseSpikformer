...
def parse_args():
    ...
    parser.add_argument('--base_weight',type=float,default=0.8)
...
def main(args):
    ...
    pretrained = torch.load('/home/ly22216501/SNN/Transformer/SparseSpikformer/cifar10dvs/logs/SEWResNet_2_b16_T16_wd0.06_adamw_cnf_ADD/lr0.001/checkpoint_max_test_acc1.pth', map_location='cpu')
