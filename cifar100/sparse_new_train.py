...
# Model detail
parser.add_argument('--model', default='sparse_spikformer', type=str, metavar='MODEL',
...
def main():
    ...
    pretrained = torch.load('/home/ly22216501/SNN/transformer/SparseSpikformer/cifar100/output/pretrained/model_best.pth.tar', map_location='cpu')
    ...
    if args.rank == 0:
        ...
        output_dir = get_outdir(args.output if args.output else './output/sparse_train_baserate_'+str(args.base_rate), exp_name)
